...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Empresa empresa1= new Empresa(null,"Empresa UniGARAGE","828270001-56");
		...
		//Registro reg1 = new Registro(null, agora.getTime(),aux.get(Calendar.DAY_OF_MONTH),aux.get(Calendar.MONTH),aux.get(Calendar.YEAR), "Entrada", func1);
