...
public class AjusteSimplificadoDTO implements Serializable{
	...
	public AjusteSimplificadoDTO(String id, String data, String hora, Integer dia, Integer mes, Integer ano,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AjusteSimplificadoDTO other = (AjusteSimplificadoDTO) obj;
		if (id == null) {
			if (other.id != null)
				return false;
